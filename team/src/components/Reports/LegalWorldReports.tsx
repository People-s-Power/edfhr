...
import AddReportComp from "./AddReport";
import ReadReportItem from "./ReadReport";
// import PropTypes from 'prop-types'

dayjs.extend(relativeTime);

const LegalWorldReports = (): JSX.Element => {
  ...
  const { loading: loadingUsers } = useQuery(GET_LAWYERS, {
  ...
  return (
    <div id="reports">
      ...
      {/* <button className="btn btn-info mb-3" onClick={() => setShow(true)}>
        Make Report
      </button> */}
      <div className="inner">
        <div className="first">
...
export default LegalWorldReports;
LegalWorldReports.propTypes = {
