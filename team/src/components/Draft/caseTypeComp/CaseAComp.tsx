      ...
      <div className="card">
        ...
        <div className="text-justify body">
          <p>
            ...
            We humbly wish to apply for the bail of {title}.{name} who shall be
            referred herein under and for the purpose of this application as OUR
            CLIENT. We have been brief by Our Client who has been suspected and
            arrested for an alleged offence of {offence_suspected}.
          </p>
          <p>
            ...
            was arrested and detained since the{" "}
            {Moment(arrested_on).format("Do MMMM YYYY")}, by men of the Nigeria
            police force till date without any formal charge preferred against
            him should be allowed to remain indefinitely in police custody
            without being admitted to bail? This indeed is the pedestal upon
            which this application is anchored.
          </p>
          <p>
          ...
          <ol>
            ...
            <li>
              That I know as a fact that from the{" "}
              {Moment(arrested_on).format("Do MMMM YYYY")}, when That I know as
              a fact that from the {Moment(arrested_on).format("Do MMMM YYYY")},
              when the suspect was arrested till date, the Nigeria Police Force
