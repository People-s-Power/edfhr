		...
		<>
			<Wrapper className="footer">
				<div className=" mb-4 inner _footer">
					...
					<section className="d-flex mb-4 footer-list container mt-5">
						<div className=" footer-list_about ">
							<ul className=" ">
						...
						<div className="d-flex flex-1 footer-list_links">
							<ul className=" w-100  ">
								<li className="  fs-4 fw-bold">Quick Links </li>
							...
							<ul className="w-100">
								<li className="  fs-4 fw-bold ">Contact info</li>
								<li className=" ">
					...
					<div className="container">
						...
						<div className="d-flex justify-content-end mb-2 py-1">
							<Link href="/contact">
								<button className="btn btn-warning px-4 fw-bold  text-light rounded-pill">
									Get in Touch
